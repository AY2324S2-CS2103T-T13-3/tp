...
with(this){return _c('p',[_c('strong',[_v("Aspect: If "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ClientStatus")]),_v(" should exist for non-clients:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Alternative 1 (current choice):")]),_v(" Partners have a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ClientStatus")]),_v(", but the value is unique and cannot be changed.\n"),_c('ul',[_c('li',[_v("Pros: Easy to implement, less change required to other parts of the model.")]),_v(" "),_c('li',[_v("Cons: Less accurate to real-life model where partners would not have a client status.")])])]),_v(" "),_c('li',[_c('strong',[_v("Alternative 2:")]),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ClientStatus")]),_v(" is wrapped in an "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Optional")]),_v(" so partners will not have a valid "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ClientStatus")]),_v(".\n"),_c('ul',[_c('li',[_v("Pros: More accurate to real-life model.")]),_v(" "),_c('li',[_v("Cons: More challenging to implement, and may result in more bugs.")])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Sat, 13 Apr 2024, 23:21:06 GMT+8]")])])])}
}];
