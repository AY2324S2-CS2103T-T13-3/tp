...
with(this){return _c('p',[_v("The following class diagram shows the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Policy")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Relationship")]),_v(" classes in relation with "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v(". Other classes associated with "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v(" are omitted for clarity. Only "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("client")]),_v(" relationship can hold policies and have a series of action to it.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 1: The users executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/David ... r/client")]),_v(" to add a new policy. Since the relationship is a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("client")]),_v(", the person is allowed to add policies. The new person will have empty policy in default.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 2: Assuming the person the user just added is the first person, the user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("policy 1 po/Policy ABC")]),_v(" to add the policy. The person now hold one "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("policy")]),_v(" which named Policy XYZ and don't contain any expiryDate and premium.")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Note:")]),_v(" The action (add, edit or delete) depends on the user input. Add action input don't need to accompany by a policy index, the other two values are optional. Edit action input need to contain policy index and policy value, the other two value are optional. Delete action input need to contain policy index and leave blank for policy value.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The following sequence diagrams shows how the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("policy")]),_v(" command go through the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(" component:")])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Sun, 14 Apr 2024, 19:57:58 GMT+8]")])])])}
}];
